...
import { Row, Col, Form, InputGroup, Button, Tab, Tabs } from 'react-bootstrap'
                ...
                <Tab eventKey="profile" title="상품사진">
                    <Row>
                        ...
                        <Col>
                            ...
                            <div className='text-center'>
                                <img onClick={() => ref_file.current.click()} src={src} width="90%" style={{ border: '1px solid gray', cursor: 'pointer' }} />
                                <input onChange={onChangeFile} type="file" ref={ref_file} style={{ display: 'none' }} />
                            </div>
                        </Col>
                        <div className='text-center mt-3'>
                            <Button onClick={onSaveImage}>이미지저장</Button>
                        </div>
                    </Row>
                </Tab>
            </Tabs>
